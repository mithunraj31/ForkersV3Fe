    ...
    <el-row>
      <el-col :span="24">
        <el-table
          ...
          size="small"
        >
          <el-table-column prop="id" :label="$t('driver.listings.licenseNo')" width="90px">
  ...
  methods: {
    mapdriversToDataTable(driver) {
      return {
        ...
        licenseRenewal: driver.license_renewal_date ? moment(driver.license_renewal_date).format('yyyy/MM/DD') : '',
